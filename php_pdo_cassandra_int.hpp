...
typedef struct {
    ...
    std::shared_ptr<PasswordCallbackTSSLSocketFactory> factory;
    std::shared_ptr<TSSLSocket> sslSocket;
    std::shared_ptr<TSocketPool> socket;
    std::shared_ptr<TFramedTransport> transport;
    std::shared_ptr<TProtocol> protocol;
    std::shared_ptr<CassandraClient> client;
...
typedef struct {
    ...
    std::shared_ptr<CqlResult> result;
